    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card shadow-lg border-0 rounded-4 h-100"
                style="background: linear-gradient(135deg, #0482d6,#00eaff,#66ff00,#fffb00);">
                <div class="card-body">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card shadow-lg border-0 rounded-4 h-100"
                style="background: linear-gradient(135deg, #ffee00, #0ee802, #00d9ff, #055aae);">
                <div class="card-body">
                    <h5 class="card-title text-primary mb-3">
